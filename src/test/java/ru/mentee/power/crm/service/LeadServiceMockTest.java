...
class LeadServiceMockTest {
  ...
  void shouldCallRepositorySaveWhenAddingNewLead() {
    ...
    Lead result = service.addLead("new@example.com", "Company", "Mega Corp", LeadStatus.NEW);
  ...
  void shouldNotCallSaveWhenEmailExists() {
    ...
    assertThatThrownBy(() ->
        service.addLead("existing@example.com", "New Company", "Not So Mega Corp", LeadStatus.NEW)
  ...
  void shouldCallFindByEmailBeforeSave() {
    ...
    // When
    service.addLead("test@example.com", "Company", "Mega Crop", LeadStatus.NEW);
